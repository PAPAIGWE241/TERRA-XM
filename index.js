...
console.log("CONNECTING TERRA-XMD...☄️");
...
console.log('TERRA-XMD CONNECTED TO WHATSAPP DONE.✅')

let up = `*╭──────────────●*
> *◥ད 𝚃𝙴𝚁𝚁𝙰 𝚇𝙼𝙳 𝚌𝚘𝚗𝚗𝚎𝚌𝚝𝚎𝚍 𝚜𝚞𝚌𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢 𝚝𝚢𝚙𝚎 .𝚖𝚎𝚗𝚞 𝚝𝚘 𝚜𝚑𝚘𝚠 𝚖𝚢 𝚕𝚒𝚜𝚝 𝚖𝚎𝚗𝚞 ཌ◤*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs 𝚃𝙴𝚁𝚁𝙰 𝚇𝙼𝙳.*

*https://whatsapp.com/channel/0029Vb2VplFFCCoQsZKtVV24*

> CREATED BY IGWETECH INC

*╭✫🫧 𝚃𝙴𝚁𝚁𝙰 𝙶𝚁𝙴𝙴𝚃𝙸𝙽𝙶    🫧✫╮*
*│ - 🪐BOT NAME:* *TERRA-XMD*
*│ - 📃DESCRIPTION:* *whatsapp bot made in library baileys*
*│ - ⚡️CREATOR:* *IGWEBOTZ*
*│ - 🌐URL:* *https://github.com/DADDY-IGWE/TERRA-XMD*

*NOW YOU CANT USE TERRA*\n\n*PREFIX: ${prefix}*

*╰──────────────●*`;
conn.sendMessage(conn.user.id, { image: { url: `https://i.imgur.com/PwJKvlA.jpeg` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("241777777777")){
if(isReact) return
m.react("👑")
}
...
app.get("/", (req, res) => {
res.send("HEY, TERRA XMD STARTED ✅");
});
